...
$(document).ready(function(){
  ...
  $('.tabs .tab1').css('background','url(../../images/tabss1on.jpg)'); //첫번째 불켜
  ...
  $('.tabs .tab').each(function (index) {
    $(this).click(function(){    //각각의 메뉴탭을 클릭하면	
	  ...
	  for(var i=1;i<=cnt;i++){     //모든버튼불꺼 
           $('.tabs .tab'+i).css('background','url(../../images/tabss'+i+'.jpg)');
      }
      $(this).css('background','url(../../images/tabss'+(index+1)+'on.jpg)'); 
   			//자신만 메뉴버튼 불켜 
